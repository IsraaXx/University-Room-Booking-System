...
class BookingServiceTest {
    ...
    void testCreateBooking_Success() {
        ...
        // When
        Booking createdBooking = bookingService.createBooking(bookingDto, 1L);
    ...
    void testUpdateBooking_Success() {
        ...
        // When
        Booking updatedBooking = bookingService.updateBooking(1L, bookingDto, 1L);
    ...
    void testApproveBooking_Success() {
        ...
        // When
        Booking approvedBooking = bookingService.approveBooking(1L, 2L);
    ...
    void testRejectBooking_Success() {
        ...
        // When
        Booking rejectedBooking = bookingService.rejectBooking(1L, 2L, "Room not available");
    ...
    void testCancelBooking_UserCancelsOwn_Success() {
        ...
        // When
        Booking cancelledBooking = bookingService.cancelBooking(1L, 1L, false);
    ...
    void testCancelBooking_AdminCancelsAny_Success() {
        ...
        // When
        Booking cancelledBooking = bookingService.cancelBooking(1L, 2L, true);
